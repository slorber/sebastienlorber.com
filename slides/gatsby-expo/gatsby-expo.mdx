...
>
        ...
        >
                <a
                        href="https://sebastienlorber.com/using-expo-in-gatsby"
                        target="_blank"
                >
...
const ReactNativeComponents = {
        ...
        a: (props) => (
                <Text onPress={() => Linking.openUrl(props.href)}>
                        {props.children}
                </View>
        ),
};
...
```jsx
const MDXComponent = require('./my-super-mdx-blog-post-transpiled')
        .MDXComponent;
