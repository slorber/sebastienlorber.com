...
Lately, I've also been a fan of [Learn In Public](https://www.swyx.io/writing/learn-in-public). When someone ask me a question, I'd rather try to answer publicly so it can help others. I also want to publish opiniated things, and get read and corrected by others, so that my ideas and skills can improve other time, and be helpful to others.
...
You don't actually need to digg deep into Gatsby plugin configuration anymore, as long as the theme supports the features you want. Even if it does not, choosing a popular theme is nice because you can expect it to be enhanced over time by the community (or your own PRs).
...
**Edit**: actually created [the newsletter](https://tinyletter.com/slorber) with Tinyletter in 5 minutes. It's not integrated to the site yet but at least those who want to can subscribe.
