...
Lately, I've also been a fan of [Learn In Public](https://www.swyx.io/writing/learn-in-public). When someone ask me a question, I'd rather try to answer publicly so it can help others. I also want to publish opiniated things, and get read and corrected others, so that my ideas and skills can improve other time, and maybe be helpful to others too.
This is weird, but many times, I've read blog posts about stuff I already knew, and finally posted comments to correct the mistakes of the article (if any). I want people to do that for me too. I may not agree with them, but definitively want constructive feedback on my posts, and will eventually change my mind and edit the original article.
...
- I started using Gatsby and it convinced my the JAMStack is the future
- I felt in love with Typescript. Was previously doing my backends in Scala, and for the first time I'm confident using Node for my next backend.
- I brought React-Native-Web support to Gatsby, with a few PRs and the [React-Native-Web plugin](https://github.com/slorber/gatsby-plugin-react-native-web) (I'll blog about it later)
- It got me started using RNW and very excited about the React Flare project, which I think will be huge.
...
You don't actually need to digg deep into Gatsby plugin configuration anymore, as long as the theme supports the features you want. Even if it does not, choosing a popular theme is nice because you can expect it to be enhanced over time by the communit (or your own PRs), and add the missing features.
...
I've noticed several themes that can actually be good to start a blog. Here's a list of themes I considered:
...
Some designs may not be suited for a blog, but actually it's not so important because you can override it.
...
Having this Lorem Ipsum blog post online actually incitates me to write my first blog post sooner. As I'm writing, this site still have the default Narrative header logo and favicon, but I don't care for now.
...
As a freelancer, it's important for me to develop my personal branding, and actually be known enough to be found by customers. Writing is for me a good opportunity to do so and it is quite natural for me (I've already wrote a lot on [StackOverflow](https://stackoverflow.com/users/82609/sebastien-lorber?tab=answers).

Other time, I've collected a list of about 50 blog titles I'd like to write. I'll cover various technologies in the React ecosystem, including React, React-Native, Expo, React-Native-Web, React-Navigation, Apollo, Typescript, Gatsby, Formik... and probably some broader topics as well.
...
But, the very next move will be to write some technical articles.
