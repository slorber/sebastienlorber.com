...
When clicking fast on the arrows, even with your own good home network, you can already see something is wrong. Please don't think debouncing protects you: it just reduces the chances of being unlucky.
...
**Note:**: it's possible to use `StarwarsHero key={id} key={id}/>` as a simple React workaround, to ensure the component instance stanges everytime the id changes. This will effectively protect you (and sometime unmounting/remounting is useful), but gives more work to React.
...
For more content like this, subscribe to my newsletter and follow me on [Twitter](https://twitter.com/sebastienlorber)

---

Thanks for my reviewers: [Shawn Wang](https://twitter.com/swyx), [Mateusz Burzyński](https://twitter.com/AndaristRake), [Andrei Calazans](https://twitter.com/Andrei_Calazans), [Adrian Carolli](https://twitter.com/icookandcode), [Clément Oriol](https://twitter.com/oriolclement), [Thibaud Duthoit](https://github.com/tidusia)
