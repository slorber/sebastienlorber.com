...
- **React-Native-Web**: it is like a CSS-in-JS (similar to Emotion) that reuse the existing React-Native APIs. It has interesting properties (like [atomic CSS-in-JS](https://sebastienlorber.com/atomic-css-in-js)).
