...
This post is a proof-of-concept: it contains React-Native and Expo interactive components, embedded directly into this [MDX](https://github.com/mdx-js/mdx) article, of my ([open-source](https://github.com/slorber/sebastienlorber.com)) Gatsby site.
