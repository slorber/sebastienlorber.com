...
**Edit**: readers reported me other solutions: [Styletron](https://www.styletron.org/), [Fela](https://github.com/robinweser/fela)
...
This predictable behavior is only possible thanks to using the most strict atomic CSS.
