...
date: 2020-07-31
excerpt: ...or how it will solve many React performance and behavior issues.
---

**Records & Tuples**, a very interesting [proposal](https://github.com/tc39/proposal-record-tuple) for the JavaScript language, has just reached **[stage 2](https://twitter.com/robpalmer2/status/1286040041089904640)** at **TC39**.
...
Records & Tuples support the same immutable update patterns that you use with Objects and Arrays:
...
So far, [ImmerJS](https://github.com/immerjs/immer) has won this battle, due to its simplicity to handle nested attributes, and interoperability with regular JS code.
...
// Vanilla JS updates
// if deep-path-properties-for-record proposal land
...
Kent C Dodds even created [a tool](https://github.com/kentcdodds/stop-runaway-react-effects) to break such infinite loops in development.
...
Thanks [Robin Ricard](https://twitter.com/r_ricard), [https://twitter.com/rickbutton](Rick Button), [Daniel Ehrenberg](https://twitter.com/littledan), [Nicolò Ribaudo](https://twitter.com/NicoloRibaudo), [Rob Palmer](https://twitter.com/robpalmer2) for their work on this awesome proposal, and for reviewing my article.
